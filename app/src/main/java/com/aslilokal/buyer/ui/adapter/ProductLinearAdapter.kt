...
import com.aslilokal.buyer.databinding.ItemProductLinearBinding
...
class ProductLinearAdapter :
    RecyclerView.Adapter<ProductLinearAdapter.LinearProductViewHolder>() {

    inner class LinearProductViewHolder(private val binding: ItemProductLinearBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LinearProductViewHolder =
        LinearProductViewHolder(
            ItemProductLinearBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )

    override fun onBindViewHolder(holder: LinearProductViewHolder, position: Int) {
